...
class Twig_Tests_Node_TransTest extends Twig_Test_NodeTestCase
{
    ...
    public function testConstructor()
    {
        ...
        $domain = new Twig_Node_Expression_Constant('domain', 0);
        ...
        $node = new Twig_Extensions_Node_Trans($body, $domain, $plural, $count, null, 0);
    ...
    public function getTests()
    {
        ...
        $body = new Twig_Node_Expression_Constant('Hello', 0);
        $domain = new Twig_Node_Expression_Constant('domain', 0);
        $node = new Twig_Extensions_Node_Trans($body, $domain, null, null, null, 0);
        $tests[] = array($node, 'echo dgettext("domain", "Hello");');
        ...
        $node = new Twig_Extensions_Node_Trans($body, $domain, $plural, $count, null, 0);
        $tests[] = array($node, sprintf('echo strtr(dngettext("domain", "Hey %%name%%, I have one apple", "Hey %%name%%, I have %%count%% apples", abs(12)), array("%%name%%" => %s, "%%name%%" => %s, "%%count%%" => abs(12), ));', $this->getVariableGetter('name'), $this->getVariableGetter('name')));
