...
configure the ``gettext`` parser to get something like this: ``xgettext --keyword="pgettext:1c,2" --keyword="npgettext:1c,2,3"``
...
.. code-block:: text
    ...
    xgettext --default-domain=messages -p ./locale --from-code=UTF-8 --keyword="pgettext:1c,2" --keyword="npgettext:1c,2,3" -n --omit-header -L PHP /tmp/cache/*.php
