<?php
/**
 * This is a Twig TokenParser that will parse custom tags, count the blocks and then fabricate an if/elseif block
 * checking the block sequence number against a random number between 1 - the total number of blocks. The block that matches the random
 * will be returned.
 *
